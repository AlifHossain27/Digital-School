...
const AddStaff = () => {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>){
        const resp = await fetch("http://localhost:8000/api/staff/signup/",{
            method: 'POST',
    ...
    if (resp.ok){
        ...
        toast({
            ...
            toast({
                variant: "destructive",
                title: `${resp.status} Staff Creation failed`,
  ...
  return (
    ...
    <Dialog>
        ...
        <DialogContent>
            <DialogHeader>
            <DialogTitle className="text-3xl">Create New Staff:</DialogTitle>
            </DialogHeader>
            <Form {...form}>
