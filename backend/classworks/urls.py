...
from .views import CreateClasswork, ListClassworks, RetrieveUpdateDeleteClasswork, CreateClassworkSubmission, CreateRetrieveClassworkPublicComment, CreateRetrieveClassworkPrivateComment, UpdateClassworkPrivateComment, RetrieveClassworkSubmissionsList, RetrieveClassworkSubmission, UpdateDeleteClassworkSubmission
...
urlpatterns = [
    ...
    path('classwork/<str:classwork_id>/<str:profile_uid>/private-comment/', CreateRetrieveClassworkPrivateComment.as_view(), name='classwork-create-private-comment'),
    path('classwork/private-comment/<int:comment_id>/', UpdateClassworkPrivateComment.as_view(), name='update-private-comment'),
