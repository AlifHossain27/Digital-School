...
from .views import CreateClasswork, ListClassworks, RetrieveUpdateDeleteClasswork, CreateClassworkSubmission, CreateRetrieveClassworkPublicComment, CreateRetrieveClassworkPrivateComment, RetrieveClassworkSubmissionsList, RetrieveClassworkSubmission, UpdateDeleteClassworkSubmission
