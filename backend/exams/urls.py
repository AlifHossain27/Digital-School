...
urlpatterns = [
    ...
    path('exam/summary/<int:submission_id>/', ExamSummaryView.as_view(), name='exam-summary'),
    path('exam/<int:exam_id>/summary/<str:student_id>/', ExamSummaryView.as_view(), name='exam-summary'),
